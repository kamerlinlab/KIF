...
class StatRegressorPostProcessor(PostProcessor):
    """
    Processes results generated by the statistical analysis module for datasets with a continous target variable.
    I.E., those generated by the "RegressionStatModel".
    ...
    def get_per_res_importance(self, stat_method: str) -> dict:
        ...
        raise ValueError(
            """You did not select one of either 'mutual_information' or 'linear_correlation' for the 'stat_method' parameter.""")
